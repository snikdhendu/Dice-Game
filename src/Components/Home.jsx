...
const Home = ({toggle}) => {
    ...
    return (
        <div class="bg-gradient-to-bl from-blue-900 to-black  min-h-screen flex items-center justify-center">
            <div className='flex flex-col h-4/5 justify-between w-1/2 items-center'>
