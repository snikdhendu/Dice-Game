...
const Rolldice = ({ currentDice, currentDice2, roleDice, isRolling }) => {
  ...
  return (
    <div className='w-full h-96 flex items-center justify-center md:gap-5 sm:gap-5 gap-4 flex-col '>
      ...
      <div><button class="text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center w-32" onClick={roleDice} >click to Roll</button></div>
    </div>
  );
};
